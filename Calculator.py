...
def bc():
    ...
    label_sum = t.Label(window1, text="", font=("Courier 22 bold"))
...
def rect():
    ...
    label_sum = t.Label(window2, text="", font=("Courier 22 bold"))
...
def tri():
    ...
    label_sum = t.Label(window7, text="", font=("Courier 22 bold"))
...
def fra():
    ...
    btn3.grid(row=4, column=0)
    label_sum = t.Label(window3, text="", font=("Courier 22 bold"))
    label_sum.grid(row=4, column=1)
...
def cir():
    ...
    label_sum = t.Label(window4, text="", font=("Courier 22 bold"))
...
def cn():
    ...
    label_sum = t.Label(window5, text="", font=("Courier 22 bold"))
...
def pon():
    ...
    label_sum = t.Label(window6, text="", font=("Courier 22 bold"))
